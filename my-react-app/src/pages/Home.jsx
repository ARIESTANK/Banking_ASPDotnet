...
function TransactionRow({ tx }) {
  const isCredit = tx.type == "deposit" || (tx.receiverId == localStorage.getItem("authUser") && tx.type=="transfer");
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        ...
        <div>
          <p style={{ fontWeight: 600, color: "#e2e8f0", fontSize: 14, marginBottom: 2 }}>{tx.description}</p>
          <p style={{ color: "#94a3b8", fontSize: 12 }}>{getCDate(tx.createdAt)}</p>
        </div>
      </div>
      <p style={{ fontWeight: 600, fontSize: 14, color: isCredit ? "#4ade80" : "#ff6363" }}>
...
const handleTransactionSuccess = (msg) => {
  ...
  fetchUserTransactions(localStorage.getItem("authUser")); // refresh transactions
};
        ...
        <main style={{ padding: "32px 48px" }}>
            ...
            <div style={{
              ...
              <div className="balance-sub-grid">
                {[
                  ...
                  { label: "Account #",   value: account.accountNumber,  mono: true  },
          ...
          <div className="anim-slide-up-d2">
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 24 }}>
              ...
              <button className="btn-gold" onClick={()=>navigate('/transactions')}>View All</button>
            </div>
            ...
            <div style={{
              ...
              {txLoading ? (
                ...
                >
                    ...
                    You haven’t made any transactions. Start by creating one.
                    </p>
                </div>
